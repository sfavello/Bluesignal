...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  const savePin = (id) => {
      if(!alreadySaved) {
          ...
          client    
            .patch(id).setIfMissing({ save: [] }).insert('after',  'save[-1]', [{
                _key: uuidv4(),
        ...
        {postHovered && (
            ...
            <div className='flex items-center justify-between'>
                ...
                {alreadySaved ? (
                    <button
                    type= "button"
                    className='bg-blue-500 opacity-70 hover:opacity-100 text-white px-5 py-1 text-base rounded-3xl hover:shadow-md outlined-none'
                    >
